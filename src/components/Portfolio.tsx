...
const Portfolio: React.FunctionComponent = () => {
    ...
    const flash = require("../images/portfolio/flash.png")
                                                ...
                                                <div className="entry-content">
                                                    ...
                                                    <div className="media-cell media format-link hentry">
                                                            <div className="media-box">
                                                                <img src={flash} alt="portfolio-post" style={{maxWidth:'100%',height: 'auto'}}/>                                                         </div>
                                                            <div className="media-cell-desc">
                                                                <h3>FlashPoster
                                                                    <div className='m-l-10'>
                                                                        <a className='btn-round demo' href="https://flashposter.ai" target="_blank" rel="noreferrer"> </a>
                                                                    </div>
                                                                </h3>
                                                                <p className="category"> FlashPoster uses Artificial Intelligence to write and publish articles on your website at the speed of light (08/23)</p>
                                                                <div className='m-t-5'>
                                                        ...
                                                        <div className="media-cell media format-link hentry">
                                                            <div className="media-box">
                                                                <img src={herobay} alt="portfolio-post" style={{maxWidth:'100%',height: 'auto'}}/>                                                         </div>
                                                            <div className="media-cell-desc">
                                                        ...
                                                        <div className="media-cell media format-link hentry">
                                                            <div className="media-box">
                                                                <img src={spider_controller} alt="portfolio-post" style={{maxWidth:'75%',height: 'auto'}}/>                                                           
                                                            </div>
                                                            <div className="media-cell-desc">
                                                        ...
                                                        <div className="media-cell media format-link hentry">
                                                            <div className="media-box">
                                                                <img src={cross_quantum} alt="portfolio-post" style={{maxWidth:'75%',height: 'auto'}}/>
                                                            </div>
                                                            <div className="media-cell-desc">
                                                                <h3> List Movies
                                                        ...
                                                        <div className="media-cell media format-link hentry">
                                                        <div className="media-box">
                                                                <img src={wing} alt="portfolio-post" style={{maxWidth:'75%',height: 'auto'}}/>                                                         </div>
                                                            <div className="media-cell-desc">
